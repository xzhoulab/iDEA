...
#' @param annotation Pre-definted gene specific annotations (gene sets, g2 x m matrix), i.e., GO term, pathways etc.
...
CreateiDEAObject <- function(summary, annotation, project = "iDEA", max_var_beta = 100, min_precent_annot = 0.005, num_core = 10){
